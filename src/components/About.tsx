  ...
  const skillCategories = [
    {
      ...
      skills: ['C/C++', 'JavaScript (Intermediate)', 'Java (Intermediate)'],
    },
    {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                A dedicated student proficient in DSA, C++, databases, Java, and Flutter, with a strong interest in algorithms, data
                structures, and Android development. Skilled in creating user-friendly apps and optimising efficiency through DSA.
